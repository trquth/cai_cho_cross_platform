...
const ProductExploreItem = (ProductItemFunction) => {
                        ...
                        <View style={{
                            ...
                            <View style={{ flex: 4 }}>
                                <View style={{ flex: 1, justifyContent: 'center' }}>
                                    <Text style={{ fontWeight: 'bold', fontSize: 12 }} numberOfLines={2}>{title}</Text>
                                </View>
                                <View style={{ flex: 1, justifyContent: 'center' }}>
...
const AddExploreProductItem = ProductExploreItem(AddProduct)
export {
    AddExploreProductItem,
    ProductExploreItem
} 